...
| **Test Suite** | **178 / 178 Passed** | 100% passing rate across 16 test suites |
...
The reconciled `npm run test` (`vitest run`) result is **16 suites / 178 tests passed**. The current comprehensive gate is `npm run check`.
